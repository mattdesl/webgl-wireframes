...
module.exports.randomizeFaces = function randomizeFaces (bufferGeometry) {
  if (bufferGeometry.getIndex()) throw new TypeError('BufferGeometry must be un-indexed!');
  ...
  bufferGeometry.addAttribute('even', new THREE.BufferAttribute(new Float32Array(even), 1));
};
